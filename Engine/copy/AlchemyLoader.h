...
#define ALCHEMY_LOADER CLoader::GetInstance()
		...
		public CSingleton<CLoader>, public EVENTDISPATCHER
	{
		...
		{
		public:
			CLoaderListener(CLoader& Parent);
			~CLoaderListener();

			void Reset(const CHAR** pcPaths, UINT uCount);
	...
	private:
		...
		CVector<CLoaderListener*> m_Listeners;
		CVector<CLoaderListener*> m_FreeListeners;
		UINT m_uFreeListenerCount;
	};
