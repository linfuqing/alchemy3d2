package alchemy.effect.blendmethod
{
	...
	public class CEffectInfoAddition extends CAbstractBlendMethod
	{
		static public const SOURCE_ALPHA:uint = 0;
		static public const DEST_ALPHA:uint = 1;
		static public const BLEND_ALPHA:uint = 2;
		
		public function CEffectInfoAddition( alphaFlag:uint )
		{
			var pointers:Array = CLibrary.method.CreateEffectInfoAddition(alphaFlag);
