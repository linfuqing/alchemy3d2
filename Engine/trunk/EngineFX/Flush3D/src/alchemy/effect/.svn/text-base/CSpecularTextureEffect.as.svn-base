package alchemy.effect
{
	...
	public class CSpecularTextureEffect extends CAbstractEffectInfo
	{
		public function CSpecularTextureEffect(channelIndex:uint = 3, samplerIndex:uint = 0, TexcoordIndex:uint = 0,  samplerData:CSamplerDeclarationData = null)
		{
			var dataPtr:uint = 0;
			...
			var pointers:Array = CLibrary.method.CreateSpecularTextureEffect(channelIndex, samplerIndex, TexcoordIndex, dataPtr);
