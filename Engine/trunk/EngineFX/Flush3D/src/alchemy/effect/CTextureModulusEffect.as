package alchemy.effect
{
	...
	public class CTextureModulusEffect extends CAbstractEffectInfo
	{
		public function CTextureModulusEffect(channelIndex:uint = 3, samplerIndex:uint = 0, texCoordIndex:uint = 0,samplerData:CSamplerDeclarationData = null)
		{
			var dataPtr:uint = 0;
			...
			var pointers:Array = CLibrary.method.CreateTextureModulusEffect(channelIndex,  samplerIndex, texCoordIndex, dataPtr);
