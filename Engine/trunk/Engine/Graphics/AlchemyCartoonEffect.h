...
namespace alchemy
{
	...
	private:
		...
		IEffectInfo::SAMPLER							m_SAMPLER	 [TOTAL_SAMPLERS  ];
		UINT													m_LightLevel;
	};
	...
	ALCHEMY_INLINE const IEffectInfo::SAMPLER      * CCartoonEffect::GetSamplers  (UINT& uSamplerCount  )
	{
	...
	ALCHEMY_INLINE const CEffectCode::ELEMENTDECLARATION         * CCartoonEffect::GetAttributes(UINT& uAttributeCount)
	{
	...
	ALCHEMY_INLINE const CEffectCode::ELEMENTDECLARATION         * CCartoonEffect::GetVarying   (UINT& uVaryingCount  )
	{
