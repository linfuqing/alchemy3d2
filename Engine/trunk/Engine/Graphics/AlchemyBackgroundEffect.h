...
namespace alchemy
{
		...
		public EFFECTINFO
	{
		...
		typedef enum
		{
			CONSTANT_WORLD_MATRIX,
			CONSTANT_VIEW_PROJECTION_MATRIX,
			CONSTANT_CAMEERA_POSITION,
	...
	ALCHEMY_INLINE const IEffectInfo::SAMPLER           * CBackgroundEffect::GetSamplers           (UINT& uSamplerCount          )
	{
	...
	ALCHEMY_INLINE const CEffectCode::ELEMENTDECLARATION            * CBackgroundEffect::GetAttributes        (UINT& uAttributeCount        )
	{
	...
	ALCHEMY_INLINE const CEffectCode::ELEMENTDECLARATION            * CBackgroundEffect::GetVarying           (UINT& uVaryingCount          )
	{
