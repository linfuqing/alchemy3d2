...
namespace alchemy
{
	class CTextureAsAttributeEffect :
		public EFFECTINFO
	{
		typedef enum
		{
	...
	public:
		CTextureAsAttributeEffect(CVertexDeclaration::ELEMENTTYPE Type, CVertexDeclaration::ELEMENTUSAGE Usage, UINT uSamplerIndex = 0, UINT uTexcoordIndex = 0, const IEffect::SAMPLERDECLARATION* pSamplerDeclaration = ALCHEMY_NULL);
		~CTextureAsAttributeEffect(void);
