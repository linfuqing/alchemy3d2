...
namespace alchemy
{
	...
	ALCHEMY_INLINE const IEffectInfo::SAMPLER      * COutLineEffect::GetSamplers  (UINT& uSamplerCount  )
	{
	...
	ALCHEMY_INLINE const CEffectCode::ELEMENTDECLARATION         * COutLineEffect::GetAttributes(UINT& uAttributeCount)
	{
	...
	ALCHEMY_INLINE const CEffectCode::ELEMENTDECLARATION         * COutLineEffect::GetVarying   (UINT& uVaryingCount  )
	{
