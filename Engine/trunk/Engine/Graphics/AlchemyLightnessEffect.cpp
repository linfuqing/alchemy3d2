...
CLightnessEffect::CLightnessEffect(UINT uLightIndex)
{
...
CLightnessEffect::~CLightnessEffect(void)
{
}

UINT                                              CLightnessEffect::GetEffectInfoFlag    (                            )
{
	return ALCHEMY_FLAG(IEffectInfo::FRAGMENT_SHADER_INFO);
}

const IEffectInfo::SAMPLER             * CLightnessEffect::GetSamplers         (UINT& uSamplerCount          )
{
...
const CEffectCode::ELEMENTDECLARATION             * CLightnessEffect::GetAttributes       (UINT& uAttributeCount        )
{
...
const CEffectCode::ELEMENTDECLARATION            * CLightnessEffect::GetVarying           (UINT& uVaryingCount          )
{
...
const CEffectCode::GLOBALVARIABLE              * CLightnessEffect::GetConstants         (UINT& uConstantCount         )
{
...
const CEffectCode::TEMPORARYDECLARATION        * CLightnessEffect::GetTemporary         (UINT& uTemporaryCount        )
{
...
const CEffectCode::ATTRIBUTEVARIABLEDECLARATION* CLightnessEffect::GetAttributeVariables(UINT& uAttributeVariableCount)
{
...
const CEffectCode::CONSTANTVARIABLEDECLARATION * CLightnessEffect::GetConstantVariables (UINT& uConstantVariableCount )
{
...
bool CLightnessEffect::ShaderDefineHandler(
	UINT uOutputColor, 
	...
	CEffectCode::CPassDefiner::CEffectCodeUtils& EffectCodeUtils)
{
	...
	{
		FragmentShaderDefiner.AppendInstruction(ICompiler::DP3, pLightness->uHandle, pAttributeVariables[ATTRIBUTE_VARIABLE_NORMAL].uHandle, pConstantVariables[CONSTANT_VARIABLE_LIGHT_LOCAL_DIRECTION_NEGATE].uHandle);
