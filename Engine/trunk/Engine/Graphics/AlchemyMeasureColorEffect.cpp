...
{
	m_Contans[CONSTANT_MEASURE_VALUE].ShaderType = IEffect::FRAGMENT_SHADER;
	m_Contans[CONSTANT_MEASURE_VALUE].GlobalType = CEffectCode::INPUT_VARIABLE;
	m_Contans[CONSTANT_MEASURE_VALUE].uDetail = CEffectCode::BuildGlobalInputCode(CEffectCode::VECTOR4_VARIABLE, 1, 4, false);
...
const IEffectInfo::SAMPLER           * CMeasureColorEffect::GetSamplers           (UINT& uSamplerCount          )
{
...
const CEffectCode::ELEMENTDECLARATION            * CMeasureColorEffect::GetAttributes        (UINT& uAttributeCount        )
{
...
const CEffectCode::ELEMENTDECLARATION            * CMeasureColorEffect::GetVarying           (UINT& uVaryingCount          )
{
...
{
	FragmentShaderDefiner.AppendInstruction( ICompiler::MOV, uOutputColor, ALCHEMY_NULL, 0, puConstants[CONSTANT_MEASURE_VALUE],ALCHEMY_NULL,0, 0, ALCHEMY_NULL, 0 );
