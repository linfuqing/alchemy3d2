...
namespace alchemy
{
	...
	public:
		CMaskTextureEffect(UINT uChannelIndex = 3, FLOAT fMaskRef = 0.6f, UINT uSamplerIndex = 0, UINT uTexcoordIndex = 0, const IEffect::SAMPLERDECLARATION* pSamplerDeclaration = ALCHEMY_NULL);
		~CMaskTextureEffect(void);
