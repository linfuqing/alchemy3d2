...
namespace alchemy
{
	...
	ALCHEMY_INLINE const IEffectInfo::SAMPLER           * CEnvironmentalEffect::GetSamplers           (UINT& uSamplerCount          )
	{
	...
	ALCHEMY_INLINE const CEffectCode::ELEMENTDECLARATION            * CEnvironmentalEffect::GetAttributes        (UINT& uAttributeCount        )
	{
	...
	ALCHEMY_INLINE const CEffectCode::ELEMENTDECLARATION            * CEnvironmentalEffect::GetVarying           (UINT& uVaryingCount          )
	{
