...
namespace alchemy
{
	class CNormalOffsetForceTextureEffect :
		public EFFECTINFO
	{
		typedef enum
		{
	...
	public:
		CNormalOffsetForceTextureEffect(FLOAT& fScale, UINT uUVIndex = 0, UINT uSamplerIndex = 0);
		~CNormalOffsetForceTextureEffect(void);
