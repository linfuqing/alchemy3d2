...
namespace alchemy
{
	class CAttributeProjectionEffect :
		public EFFECTINFO
	{
		typedef enum
		{
	...
	public:
		CAttributeProjectionEffect(CVertexDeclaration::ELEMENTUSAGE Usage, bool bIsNoraml, UINT uIndex = 0);
		~CAttributeProjectionEffect(void);
