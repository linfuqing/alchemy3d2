...
#define ALCHEMY_MESH_MANAGER CMeshManager::GetInstance()
	...
	public:
		...
		static void DestroyTextureData(TEXTUREDATA& TextureData);
		static void DestroyMaterialData(MATERIALDATA& MaterialData);
		static void DestroySkinData(SKINDATA& SkinData);
		static void DestroySceneNodeData(SCENENODEDATA& SceneNodeData);
		static void DestroySceneData(SCENEDATA& SceneData);
