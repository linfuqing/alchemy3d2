...
CQuadTree::CQuadTreeObject::CQuadTreeObject(CSceneTreeObjectInterface& SceneTreeObject) :
CSceneTreeManagerInterface::CSceneTreeObjectIterator(SceneTreeObject),
...
void CQuadTree::CQuadTreeNode::AddMemberToSearchList(
	...
	UINT32 uMaskY,
	const CClipperInterface* pClipper)
{
...
{
	CQuadTreeObject* pObject;
	const CBoundingVolumeInterface* pBoundingVolume;
	if( ALCHEMY_TEST_ANY(m_uLocalMaskY, uMaskY) )
	{
		for(pObject = m_pMembers; pObject; pObject = pObject->m_pTreeForward)
		{
...
CSceneTreeManagerInterface::CSceneTreeObjectIterator* CQuadTree:: SearchObject(const CBoundingVolumeInterface& BoundingVolume, const CClipperInterface* pClipper, CSceneTreeManagerInterface::CSceneTreeObjectIterator** ppSearchListTail)
{
...
bool CQuadTree::AddObject(CSceneTreeObjectInterface& SceneTreeObject)
{
	if(!m_uDepth)
	{
...
{
	static CBoundingBox ConvertBoundingBox;
...
CQuadTree::CQuadTreeObject& CQuadTree::__CreateQuadTreeObject(CSceneTreeObjectInterface& SceneTreeObject)
{
