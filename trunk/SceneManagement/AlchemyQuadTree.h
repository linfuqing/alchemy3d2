...
{
	class CQuadTree :
		public CSceneTreeManagerInterface
	{
		typedef enum
		{
		...
		class CQuadTreeObject :
			public CSceneTreeManagerInterface::CSceneTreeObjectIterator
		{
			friend class CQuadTree;
			friend class CQuadTreeNode;
		public:
			CQuadTreeObject(CSceneTreeObjectInterface& SceneTreeObject);
	...
	public:
		...
		CSceneTreeObjectIterator* SearchObject(const CBoundingVolumeInterface& BoundingVolume, const CClipperInterface* pClipper, CSceneTreeManagerInterface::CSceneTreeObjectIterator** ppSearchListTail);

		bool AddObject(CSceneTreeObjectInterface& SceneTreeObject);
	...
	private:
		...
		CQuadTreeObject& __CreateQuadTreeObject(CSceneTreeObjectInterface& SceneTreeObject);
	...
	ALCHEMY_INLINE UINT32 __GetMaskY(UINT8 uMinY, UINT8 uMaxY)
	{
