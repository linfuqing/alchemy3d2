...
MATRIX4X4& alchemy::RotationQuaternion(MATRIX4X4& Output, CQuaternion& Quaternion)
{
...
void CMatrix4x4::PerspectiveFieldOfViewLeftHand(FLOAT fTop, FLOAT fBottom, FLOAT fLeft, FLOAT fRight, FLOAT fNear, FLOAT fFar)
{
...
void CMatrix4x4::PerspectiveFieldOfViewLeftHand(FLOAT fFOV, FLOAT fAspect, FLOAT fNear, FLOAT fFar)
{
	FLOAT fTop = tanf(fFOV * 0.5f), fRight = fTop * fAspect;

	PerspectiveFieldOfViewLeftHand(fTop, - fTop, - fRight, fRight, fNear, fFar);
}
