...
namespace alchemy
{
	...
	public:
		CShadowMapDisplayEffect(UINT uShadowMapIndex, UINT uLightIndex, const FLOAT& Epsilon);
	...
	private:
		...
		CEffectInfoInterface::SAMPLER                          m_Samplers          [TOTAL_SAMPLERS          ];
		CEffectCode::ELEMENTPARAMETER                          m_Varying           [TOTAL_VARYING           ];
