...
namespace alchemy
{
	...
	public:
		...
		bool Create(CMesh& Mesh, SKINTYPE SkinType, CSkinInfo& SkinInfo, CBone& Root, const CEffectCode::ELEMENTPARAMETER* pSkinElementParameters, UINT uElementCount, UINT uMaxBoneInfluence = 0, CEffectCode* pEffectCode = ALCHEMY_NULL);
		bool Create(CMesh& Mesh, SKINTYPE SkinType, CSkinInfo& SkinInfo, CBone& Root, UINT uMaxBoneInfluence = 0, CEffectCode* pEffectCode = ALCHEMY_NULL);
