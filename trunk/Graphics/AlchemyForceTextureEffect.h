...
namespace alchemy
{
	...
	public:
		CForceTextureEffect(UINT uSamplerIndex = 0, UINT uTexcoordIndex = 0, const CEffectCode::SAMPLERDECLARATION* pSamplerDeclaration = ALCHEMY_NULL);
	...
	private:
		...
		CEffectCode::ELEMENTPARAMETER m_Attributes[TOTAL_ATTRIBUTES];
		CEffectCode::ELEMENTPARAMETER m_Varing    [TOTAL_VARYING   ];
	};
}